...
- **Uživo reprodukovano mucanje** (Playwright MCP, vlasnik dao test nalog za ovu svrhu): login `fica`/`fF2024BG2025` na `gw.castcdn.net`, kanal **PRVA (lista #6)**, catch-up program „06:45 Plodovi" (`data-catchup-start-ms=1781325900000`). Catch-up servira **streamId 109** (PRVA live = 1526 daje 403=mrtav, nebitno za catch-up).
