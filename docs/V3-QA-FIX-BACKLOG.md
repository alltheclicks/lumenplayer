...
5. Release matrix guard added for beta readiness:
   ...
   - Partial release-readiness rollup artifact: `artifacts/release/readiness/qaf035-release-readiness-20260602.json`.
     - It links current compatibility, capacity, provider owner, runtime media policy, performance evidence, observability baseline, security/privacy baseline, manual-device, and beta ops artifacts, records open blockers for capacity owner, target devices, and beta ops signoff, and keeps final signoff pending.
