...
- QAF-026 merged via PR #200 (Greptile final confidence `95/100`; approved 4/5+ exception with explicit no-blocker rationale).
- QAF-027 merged via PR #201 (Greptile final confidence `95/100`; approved 4/5+ exception with explicit no-blocker rationale).
...
- New intake wave (`BUG-20260221-01..08`) is triaged as `QAF-024..QAF-031`; `QAF-024..QAF-027` are completed, `QAF-028..QAF-031` remain planned.
