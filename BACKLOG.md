...
- QAF-026 merged via PR #200 (Greptile `4/5`; approved no-blocker exception with explicit rationale).
- QAF-027 merged via PR #201 (Greptile `4/5`; approved no-blocker exception with explicit rationale).
- QAF-028 merged via PR #203 (Greptile `5/5`).
- QAF-029 merged via PR #204 (Greptile `4/5`; approved no-blocker exception after stale repeated comment on already-fixed a11y note).
- QAF-030 merged via PR #205 (Greptile `4/5`; approved no-blocker exception pending real-provider runtime validation).
