...
const SeriesCategories = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Series Categories - IPTV Player</title>
      </Helmet>
      ...
      <div className="bg-background p-4 md:p-6">
        <div className="mx-auto max-w-7xl space-y-5">
          ...
          {!isLoading && !error && selectedCategory === undefined && (
            <p className="text-sm text-muted-foreground">
              Select a category to load series, or choose <strong>All</strong> to load the full catalog.
            </p>
          )}

          {error && (
            <p className="text-destructive">
              Failed to load series catalog: {error.message}
            </p>
          )}
