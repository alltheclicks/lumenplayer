...
import { CatchUpProgramPanel } from '@/components/player/CatchUpProgramPanel';
...
const PlayerControls = ({
      ...
      <>
        ...
        {showCatchUp && (
          <CatchUpProgramPanel
            ...
            selectedProgram={catchUpProgram}
            programsByDate={catchUpByDate}
            sortedDates={sortedDates}
            openDays={openDays}
            emptyStateReason={catchUpEmptyStateReason}
  ...
  return (
    ...
    >
      ...
      {showCatchUp && (
        <CatchUpProgramPanel
          className="absolute bottom-0 right-0 top-0 z-30 w-full border-l border-border/50 bg-background/95 backdrop-blur-md sm:w-96"
          selectedProgram={catchUpProgram}
          programsByDate={catchUpByDate}
          sortedDates={sortedDates}
          openDays={openDays}
