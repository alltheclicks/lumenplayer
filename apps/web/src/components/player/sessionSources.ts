...
export const isVodSessionSourceMetadata = (
  metadata: ParsedSessionSourceMetadata,
): metadata is VodSessionSourceMetadata => metadata.mode === 'vod';

export const isSeriesEpisodeSessionSourceMetadata = (
  metadata: ParsedSessionSourceMetadata,
): metadata is SeriesEpisodeSessionSourceMetadata => metadata.mode === 'series-episode';
...
export const buildVodSessionSource = ({
  url,
  type,
  title,
  vodId,
  ...
  metadata: {
    ...
    streamId,
    backPath,
  } satisfies VodSessionSourceMetadata,
});

export const buildSeriesEpisodeSessionSource = ({
  url,
  type,
  title,
  seriesId,
  ...
  metadata: {
    ...
    episodeNumber,
    backPath,
  } satisfies SeriesEpisodeSessionSourceMetadata,
});
